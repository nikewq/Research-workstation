...
Page({
  data: {
    ...
    ciDone: false, coTime: '', ciStatus: '未签到', workTime: '',
  ...
  onShow() {
    try {
      ...
      wx.showModal({ title: 'onShow crash', content: String(e).slice(0, 300), showCancel: false })
    }
  },
  ...
  _refresh() {
    ...
    this.setData({
      ...
      ciDone, coTime: coTime || '', ciStatus, workTime: wt || '',
